...
import MentalHealthSummary from "./compnents/MentalHealthSummary.js";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        />
        <Route
          path="/:username/anonymoussharing"
          element={
            <PrivateRoute>
              <AnonymousSharing />
            </PrivateRoute>
        ...
        />
        <Route
          path="/:username/createanonymouspost"
          element={
            <PrivateRoute>
              <AnonymousPost />
            </PrivateRoute>
        ...
        />
        <Route
          path="/:username/allanonymousposts"
          element={
            <PrivateRoute>
              <AllAnonymousPost />
            </PrivateRoute>
