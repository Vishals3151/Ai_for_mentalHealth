...
const Readjournal = () => {
    ...
    useEffect(() => {
        const fetchJournals = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_URL}/${username}/journals`);
    ...
    const confirmDelete = async () => {
        try {
            await axios.delete(`${process.env.REACT_APP_API_URL}/journal-delete/${username}/${journalToDelete}`);
